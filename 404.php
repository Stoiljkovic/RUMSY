<?php
require_once('_engine_banned.php');    // IMPORTANT - MUST BE INCLUDED FIRST, ABOVE ALL
include_once('header.inc.php');     // INCLUDE <HEAD> PART (SKIN RELATED)
include_once ('mainmenu.inc.php');  // INCLUDE MAIN MENU (SKIN RELATED)
?>

        <div class="container">
            <h1 style="font-size: 400%;text-align: center;margin-top: 10%;">ERROR 404: Not found</h1>
        </div>
